...
# ── Triggers (ANT Neuro eego-mylab via parallel port) ─────────────────────────
TRIG_START           = None           # EEG recording start
TRIG_STOP            = None           # EEG recording stop
TRIG_TARGET          = 255          # Buzz Lightyear catch trial

# ── Display ────────────────────────────────────────────────────────────────────
BACKGROUND_COLOR     = [0.247, 0.271, 0.298]  # RGB in [-1,1]
STIM_SIZE_PIX        = [400, 400]             # stimulus size in pixels
PHOTODIODE_SIZE      = 50                     # white square side length in pixels (top-right corner)

# ── Presentation structure ─────────────────────────────────────────────────────
IMG_PER_SEQUENCE     = 20
TRAIN_SEQ_PER_BLOCK  = 56
TEST_SEQ_PER_BLOCK   = 51
TRAIN_BLOCKS         = 15           # total training blocks per session
TEST_RUNS            = 4            # runs 1–4
TARGETS_PER_BLOCK    = 6
