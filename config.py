...
SUBJECT_SCREEN       = 0           # 0 = experimenter monitor, 1 = subject monitor
PARALLEL_PORT_ADDR   = 0
...
TRIGGER_DELAY        = 0.015        # 11 ms delay before trigger (half flip + 3ms)
...
TRIG_TARGET          = 126            # Buzz Lightyear catch trial
...
# ── Folders ────────────────────────────────────────────────────────────────────
ORDER_DIR            = '/home/phantasos/python_projects/space/eeg_things_paradigm/eeg-things-paradigm/data/stimuli_order'
DATA_DIR             = '/home/phantasos/python_projects/space/eeg_things_paradigm/eeg-things-paradigm/data/behavior'
IMG_DIR              = '/home/phantasos/python_projects/space/eeg_things_paradigm/eeg-things-paradigm/data/stimuli'
